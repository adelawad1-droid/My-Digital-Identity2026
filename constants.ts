...
export const LANGUAGES_CONFIG: Record<Language, { name: string, native: string, dir: 'rtl' | 'ltr', flag: string }> = {
  ...
  // اللغات الأخرى معطلة مؤقتاً ويمكن إعادة تفعيلها بحذف التعليق عنها
  /*
  ...
  */
} as any; // استخدام as any لتجاوز قيود Union Type مؤقتاً عند التعطيل
...
export const BACKGROUND_PRESETS = [
  ...
  'https://images.unsplash.com/photo-1516450360452-9312f5e8fc7?auto=format&fit=crop&q=80&w=800',
...
export const TRANSLATIONS: TranslationStrings = {
  ...
  home: { en: 'Home', ar: 'الرئيسية', es: 'Inicio', fr: 'Accueil', de: 'Startseite', zh: '首页', ja: 'ホーム', pt: 'Início', ru: 'الرئيسية', hi: 'होम' },
  howToStart: { en: 'How to Start', ar: 'كيف تبدأ' },
  templates: { en: 'Templates', ar: 'القوالب', es: 'Plantillas', fr: 'Modèles', de: 'Vorlagen', zh: '模板', ja: 'テンプレート', pt: 'Modelos', ru: 'Шаблооны', hi: '테म्पलेट्स' },
  ...
  saveChanges: { en: 'Save Changes', ar: 'حفظ التعديلات', es: 'Guardar', fr: 'Enregistrer', de: 'Speichern', zh: '保存更改', ja: '変更を保存', pt: 'Salvar', ru: 'Сохранить', hi: 'परيفيرتن سيهيجين' },
  ...
  placeholderName: { en: 'Enter your name', ar: 'أدخل اسمك الكامل', es: 'Ingresa tu nombre', fr: 'Entrez votre nom', de: 'Name eingeben', zh: '输入姓名', ja: '名前を入力', pt: 'Digite seu नाम', ru: 'Введите имя', hi: 'अपना नाम दर्ज करें' },
  theme: { en: 'Theme', ar: 'السمة', es: 'Tema', fr: 'Thème', de: 'Theما', zh: '主题', ja: 'テーマ', pt: 'Tema', ru: 'Тема', hi: 'थीम' },
  saveContact: { en: 'Save Contact', ar: 'حفظ جهة الاتصال', es: 'Guardar contacto', fr: 'Enregistrer le contact', de: 'Kontakt speichern', zh: '保存联系人', ja: '連絡先を保存', pt: 'Salvar contacto', ru: 'Сохранить контакт', hi: 'संपर्क سيهيجين' },
  call: { en: 'Call', ar: 'اتصال', es: 'Llamار', fr: 'Appeler', de: 'Anrufen', zh: '呼جة', ja: '電話', pt: 'Ligar', ru: 'Позвонить', hi: 'कॉल करें' },
  ...
  heroTitle: { en: 'Professional Digital Business Cards', ar: 'بطاقات أعمال رقمية احترافية', es: 'Tarjetas de visita digitales', fr: 'Cartes de visite numériques', de: 'Digitale Visitenكارتن', zh: '专业数字名片', ja: 'プロフェッショナルな名片', pt: 'Cartões de Visita Digitais', ru: 'Цифровые визитки', hi: 'पेशेور डिजिटल ビジネス カード' },
  heroDesc: { en: 'The easiest way to share your professional profile with the world.', ar: 'الطريقة الأسهل لمشاركة ملفك المهني مع العالم.', es: 'La forma más fácil de compartir tu perfil.', fr: 'Le moyen le plus simple de partager votre profil.', de: 'Der einfachste Weg, Ihr Profil zu teilen.', zh: '分享您的个人资料的最简单方法。', ja: 'プロフィールを共有する最も簡単な方法。', pt: 'A maneira más fácil de compartilhar seu perfil.', ru: 'Самый простой способ поделиться своим профилем.', hi: 'अपनी प्रोफ़ائل साझा करने का सबसे आसान तरीكا।' },
  ...
  template: { en: 'Layout Template', ar: 'قالب التوزيع', es: 'Plantilla', fr: 'Modèle', de: 'Layout', zh: '布局模板', ja: 'レイアウト', pt: 'Modelo de Layout', ru: 'Шаблон макета', hi: 'लेवाउट टेम्पलेट' },
  ...
  website: { en: 'Website URL', ar: 'رابط الموقع', es: 'Sitio web', fr: 'Site web', de: 'Webseite', zh: '网址', ja: 'ウェブサイト', pt: 'Website', ru: 'Веب-сайт', hi: 'वेबไซต์' },
  location: { en: 'Location Address', ar: 'عنوان الموقع', es: 'Dirección', fr: 'Adresse', de: 'Adresse', zh: '地址', ja: '住所', pt: 'Endereço', ru: 'Адрес', hi: 'पता' },
  locationUrl: { en: 'Google Maps Link', ar: 'رابط خريطة قوقل', es: 'Enlace Google Maps', fr: 'Lien Google Maps', de: 'Google Maps Link', zh: 'Google Maps 链接', ja: 'Google Maps リンク', pt: 'Link Google Maps', ru: 'Ссылка Google Maps', hi: 'गूغل मैपस لينك' },
  ...
  saveTemplate: { en: 'Save Template', ar: 'حفظ القالب', es: 'Guardار plantilla', fr: 'Enregistrer le modèle', de: 'Vorlage speichern', zh: '保存模板', ja: 'テンプレートを保存', pt: 'Salvar Modelo', ru: 'Сохранить шаблон', hi: 'टेम्पलेट سيهيجين' },
